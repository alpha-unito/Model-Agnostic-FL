...
wandb.init(project="Federated_Learning_Fl_Chain2",settings=wandb.Settings(_service_wait=120))

federation = Federation(client_id=client_id, director_node_fqdn=args.server, director_port='50054', tls=False)
fl_experiment = FLExperiment(federation=federation, experiment_name="RandomForest_Fl_Chain",
