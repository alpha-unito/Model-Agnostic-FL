...
def deconstruct_proto(model_proto, compression_pipeline, nn):
    ...
    """
    # extract the tensor_dict and metadata
    bytes_dict, metadata_dict = model_proto_to_bytes_and_metadata(model_proto, nn)
...
def datastream_to_proto(proto, stream, logger=None):
    ...
    Args:
        proto: The protobuf of the model
