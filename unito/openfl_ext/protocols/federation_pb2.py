...
_SYNCHREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='SynchRequest.header', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='task_name', full_name='SynchRequest.task_name', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='round_number', full_name='SynchRequest.round_number', index=2,
...
_SYNCHRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='SynchResponse.header', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='is_completed', full_name='SynchResponse.is_completed', index=1,
...
_METADATAPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='model', full_name='MetadataProto.model', index=3,
...
_SYNCHREQUEST.fields_by_name['header'].message_type = _MESSAGEHEADER
_TASKSRESPONSE.fields_by_name['header'].message_type = _MESSAGEHEADER
_SYNCHRESPONSE.fields_by_name['header'].message_type = _MESSAGEHEADER
...
SynchRequest = _reflection.GeneratedProtocolMessageType('SynchRequest', (_message.Message,), {
  ...
  '__module__' : 'federation_pb2'
  # @@protoc_insertion_point(class_scope:SynchRequest)
  })
...
SynchResponse = _reflection.GeneratedProtocolMessageType('SynchResponse', (_message.Message,), {
  ...
  '__module__' : 'federation_pb2'
  # @@protoc_insertion_point(class_scope:SynchResponse)
  })
...
_AGGREGATOR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetSynch',
    full_name='Aggregator.GetSynch',
    index=1,
    containing_service=None,
    input_type=_SYNCHREQUEST,
    output_type=_SYNCHRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetTensor',
    full_name='Aggregator.GetTensor',
    index=3,
    containing_service=None,
    input_type=_TENSORREQUEST,
    output_type=_TENSORRESPONSE,
