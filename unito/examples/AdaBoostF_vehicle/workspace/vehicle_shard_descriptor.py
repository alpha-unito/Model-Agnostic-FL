...
class vehicleShardDataset(ShardDataset):
...
class vehicleShardDescriptor(ShardDescriptor):
    ...
    def download_data(self):
        X, y = load_svmlight_file("../vehicle_dataset/vehicle.svmlight")
        X = X.toarray()
        y = y.astype("int")
