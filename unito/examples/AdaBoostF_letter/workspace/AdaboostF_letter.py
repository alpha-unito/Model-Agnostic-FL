...
from unito.examples.AdaBoostF_letter.director.adaboost import AdaBoostF
...
fl_experiment = FLExperiment(federation=federation, experiment_name="AdaboostF_letter",
                             serializer_plugin='openfl.plugins.interface_serializer.dill_serializer.DillSerializer')
model_interface = ModelInterface(
    model=AdaBoostF(base_estimator=DecisionTreeClassifier(max_leaf_nodes=10), n_classes=26),
    optimizer=None,
    framework_plugin='unito.openfl_ext.generic_adapter.GenericAdapter')
federated_dataset = letterDataset()
