...
from spliceDataset import spliceDataset
...
fl_experiment = FLExperiment(federation=federation, experiment_name="AdaboostF_splice",
...
federated_dataset = spliceDataset()
