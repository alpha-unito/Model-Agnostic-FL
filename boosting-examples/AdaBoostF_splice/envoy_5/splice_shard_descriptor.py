...
class spliceShardDataset(ShardDataset):
...
class spliceShardDescriptor(ShardDescriptor):
    ...
    def download_data(self):
        X, y = load_svmlight_file("../splice_dataset/splice.svmlight")
        X = X.toarray()
        y = y.astype("int")
