...
class pendigitsShardDataset(ShardDataset):
...
class pendigitsShardDescriptor(ShardDescriptor):
    ...
    def download_data(self):
        df_tr = pd.read_csv("../pendigits_dataset/pendigits.tr.csv", header=None)
        df_te = pd.read_csv("../pendigits_dataset/pendigits.te.csv", header=None)
