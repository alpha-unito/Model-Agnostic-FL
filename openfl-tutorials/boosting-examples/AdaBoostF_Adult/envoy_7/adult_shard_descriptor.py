...
class AdultShardDescriptor(ShardDescriptor):
    ...
    def download_data(self):
        X_train, y_train = load_svmlight_file("../adult_dataset/adult.tr.svmlight")
        X_test, y_test = load_svmlight_file("../adult_dataset/adult.te.svmlight")
